...
class SudokuCell {
        ...
        public Boolean isLegalToInsert(int value, SudokuPuzzle currentPuzzle) {
                ...
                for (int row= 0; row< rowCount; row++){
                    ...
                    for (int column = 0; column < columnCount;column++) {
                            ...
                            if (isLegalForRow(value))

                            {

                                    if(isLegalForColumn(value))

                                    {

                                            if(isLegalForBox(value))
            ...
            return false;
                        ...
                        //if (row < 1 || row > 9 || column < 1 || column 
        ...
        private Boolean isLegalForBox(int digit) {
        	 for (int boxr = 0; boxr<boxSize; boxr ++) {

                 for (int boxc=0; boxc<boxSize; boxc++) {

                         if(digit==puzzle.get(boxr+ boxRow, boxc+boxColumn))
