...
class SudokuPuzzle {
         ...
         *         and false sEmptyValotherwise
         */
        public Boolean isEmpty(int row, int column) {
                // FIXME
        	if (isEmptyValue(get(row,column))) {
                return true;
                }
                else return false;
        }
                ...
                if (hasEmptyCell()) {
                    for (int row=0; row< rowCount; row++){
                            for (int column=0; column< columnCount;column++){
                                    ...
                                    //Cell[row][column]= new SudokuCell();
                            }
                            }
                    }
                return null;
        ...
        public void show() {
                ...
                for (int row = 0; row < rowCount; row++) {
                        ...
                        for (int column = 0; column < columnCount; column++) {
                                ...
                                if ((isEmpty(row, column) != null && isEmpty(row, column)) || this.grid[row][column] == 0){
                                        if(extraDigits){
                                                System.out.print(' ');
                                        }
                                        System.out.print(' ');
